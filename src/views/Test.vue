        ...
        <form-wizard shape="tab" class="w-full -mt-16" @on-complete="handleSubmit(submit)" ref="wizard" title="" subtitle="" transition="fade-in">
            ...
            <div class="w-11/12 my-4 text-sm mx-auto" :class="accordionClasses">
              <div @click="toggleAccordion" class="flex flex-row cursor-pointer">
                ...
                <div class="flex flex-col w-1/12">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-8 h-8 -mt-1 ml-auto icon-cheveron-down" v-if="!isOpen">
                    <path fill-rule="evenodd" d="M15.3 10.3a1 1 0 0 1 1.4 1.4l-4 4a1 1 0 0 1-1.4 0l-4-4a1 1 0 0 1 1.4-1.4l3.3 3.29 3.3-3.3z"></path>
                  </svg>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-8 h-8  ml-auto icon-cheveron-up" v-if="isOpen">
                    <path class="secondary" fill-rule="evenodd" d="M8.7 13.7a1 1 0 1 1-1.4-1.4l4-4a1 1 0 0 1 1.4 0l4 4a1 1 0 0 1-1.4 1.4L12 10.42l-3.3 3.3z"></path>
                  </svg>
                </div>
              </div>
          ...
          <tab-content>
            ...
            <table class="table-auto my-8 mx-auto text-lg text-gray-800">
              ...
              <t-content name="radio-8" text="Saya merasa terlalu sering melakukan aktivitas otomatis untuk merespon cemas"
                subtext="Contoh: menggigit kuku, menarik nafas panjang berulang, bicara banyak saat cemas, memotong pembicaraan yang membuat cemas, dsb."></t-content>
